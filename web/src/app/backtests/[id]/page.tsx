      ...
      {backtest.status !== "COMPLETED" || !report ? (
        ...
        <>
          {report.curveFittingWarning && (
            <div className="rounded-lg border border-amber-900/50 bg-amber-950/30 p-4 text-base text-amber-400">
          ...
          <section>
            <h2 className="text-xl font-medium">Equity curve</h2>
          ...
          <section>
            <h2 className="text-xl font-medium">Trade log</h2>
